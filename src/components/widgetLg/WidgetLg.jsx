    ...
    <div className="widgetLg">
      ...
      <table className="widgetLgTable">
        ...
        <tr className="widgetLgTr">
          ...
          <td className="widgetLgDate">12 Jun 2024</td>
          <td className="widgetLgAmount">$89.00</td>
          <td className="widgetLgStatus">
            <Button type="Pending" />
          </td>
        </tr>
        <tr className="widgetLgTr">
          <td className="widgetLgUser">
            <img
              ...
              className="widgetLgImg"
            />
            <span className="widgetLgName">Nick</span>
          </td>
          <td className="widgetLgDate">14 May 2024</td>
        ...
        <tr className="widgetLgTr">
          <td className="widgetLgUser">
            <img
              ...
              className="widgetLgImg"
            />
            <span className="widgetLgName">Peter Min</span>
          </td>
          <td className="widgetLgDate">12 May 2021</td>
